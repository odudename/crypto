...
?>
            ...
            <script>
                jQuery(document).ready(function() {
                            jQuery(
                                    "#crypto_available, #crypto_manage_domain, #crypto_ipfs_domain, #crypto_blockchain_url, #crypto_register_domain"
                                )
                                .hide();

                            var final_domain = "<?php echo esc_js(sanitize_text_field($_GET['domain'])); ?>";

                            jQuery("#crypto_domain_name").text(final_domain);

                            var site_url = "<?php echo esc_url(get_site_url()); ?>";
                            jQuery("#crypto_manage_domain").attr("href", site_url + "/web3/" + final_domain + "/?domain=manage");
                            jQuery("#crypto_ipfs_domain").attr("href", site_url + "/web3/" + final_domain + "/");
                                                            ...
                                                            if (domain_owner.toLowerCase() === account.toLowerCase()) {
                                                                ...
                                                                if (method == 'crypto_transfer') {
                                                                    ...
                                                                    if (!transfer_to) {
                                                                        ...
                                                                        var domain_transfer = await transferFrom(
                                                                            transfer_to,
                                                                            domain_id);
            ...
            <div class="fl-card" id="crypto_panel">
                ...
                <footer class="fl-card-footer">
                    ...
                    <a href="<?php echo esc_url($this->url_page); ?>" target="_blank" class="fl-card-footer-item"
