                ...
                ?>
                        ...
                        <script>
                            function update_api(claim_name) {
                                fetch('https://web3domain.org/endpoint/v1/index.php?domain=' + claim_name + '&update=yes&' + Math
                                        .random())
                                    .then(res => res.json())
                                    .then((out) => {
                                                    ...
                                                    if (domain_owner.toLowerCase() === account.toLowerCase()) {
                                                        ...
                                                        if (method == 'crypto_record') {
                                                            ...
                                                            if (TokenURI == true) {
                                                                ...
                                                                setTimeout(function() {
                                                                    //alert("hi");
                                                                    jQuery('#crypto_connect_ajax_process').trigger(
                                                                        'click');
                                                                }, 1000);

                                                                jQuery('#crypto_publish_record').hide('slow');
                                ...
                                <div class="fl-column fl-is-full">
                                    <div class="fl-box">
                                        ...
                                        <div class="fl-field fl-is-grouped">
                                            ...
                                            $uploaddir = wp_upload_dir();
                                            $base_path =  $uploaddir['basedir'] . "/yak/" . $subdomain . '_pending.json'; //upload dir.
...
<?php
            ...
            {
                $uri = "https://web3domain.org/endpoint/v1/index.php?domain=" . $domain_name . "&" . rand();

                if ($update == 'true') {
                    $uri = "https://web3domain.org/endpoint/v1/index.php?domain=" . $domain_name . "&update=true&" . rand();
                }
