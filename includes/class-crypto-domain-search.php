    ...
    public function add_fields($new)
    {
        $fields = array(
            'crypto_marketplace_settings' => array(
                ...
                array(
                    'name' => 'nft_storage_api',
                    'label' => __('NFT.Storage API Key', 'crypto'),
                    'description' => __('Visit nft.storage and get free api key', 'crypto'),
                    'size' => 'large',
                    'type' => 'text',
                    'sanitize_callback' => 'sanitize_text_field',
                ),
        ...
        <script>
            jQuery(document).ready(function() {
                ...
                function crypto_check_w3d_name_json(final_domain) {
                    fetch('https://web3domain.org/endpoint/v1/index.php?domain=' + final_domain)
                        .then(res => res.json())
                        .then((out) => {
